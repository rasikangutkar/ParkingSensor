...
void loop() {
  ...
  //displayData();
  zoneDetection();
//prints zone within the zone detection function.
//make changes: make smaller buffer
//average out the zone 
//separate functions for 4 and 5?


//  Serial.println();
  ticks_msg.header.stamp = nh.now();
  ticks_msg.header.frame_id = 0;
  ticks_msg.vector.x = ticks_left;
  ticks_msg.vector.y = ticks_right;
  ticks_msg.vector.z = 0.0;
